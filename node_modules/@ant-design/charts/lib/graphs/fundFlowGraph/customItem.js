...
exports.registerFundFlowItems = void 0;
...
var getPathInfo = function (cfg) {
    ...
    var startArrow = utils_1.getArrowCfg(startArrowCfg, cfg);
    var endArrow = utils_1.getArrowCfg(endArrowCfg, cfg);
    return {
...
var registerFundFlowItems = function () {
    // 注册节点
    g6_1.default.registerNode('fund-card', {
        // @ts-ignore
        draw: function (cfg, group) {
            ...
            var paddingArray = utils_1.getCssPadding(padding);
            var size = utils_1.getSize(cfg.size);
                ...
                var createRowItems_1 = function (item, contentWidth, startX) {
                    ...
                    if (icon) {
                        iconShape = group.addShape('image', {
                            attrs: __assign({ x: startX, y: height, img: icon, width: contentHeight, height: contentHeight }, utils_1.getStyle(labelStyle, cfg, group, 'icon')),
                            name: 'fund-icon',
                        });
                    }
                    textShape = group === null || group === void 0 ? void 0 : group.addShape('text', {
                        attrs: __assign(__assign({ textBaseline: 'middle', textAlign: iconShape ? 'start' : 'center', x: startX +
                                (iconShape ? (iconShape === null || iconShape === void 0 ? void 0 : iconShape.getBBox().width) + constants_1.defaultMargin : contentWidth / 2), y: paddingArray[0] + contentHeight / 2, text: text }, constants_1.defaultLabelStyle), utils_1.getStyle(labelStyle, cfg, group, 'text')),
                        name: "fund-text",
                    });
    ...
    // 注册边
    g6_1.default.registerEdge('fund-line', {
        // @ts-ignore
        draw: function draw(cfg, group) {
            ...
            var createItem = function (itemText, key) {
                group.addShape('text', {
                    attrs: __assign(__assign({ text: itemText, x: line2StartPoint.x, y: key === 'text' ? endY - 4 : endY + 16 }, constants_1.defaultLabelStyle), utils_1.getStyle(labelStyle, cfg, group, key)),
                    name: "line-text-" + key,
                });
            };
        ...
        update: function (cfg, edge) {
            ...
            texts.forEach(function (key) {
                ...
                textShape === null || textShape === void 0 ? void 0 : textShape.attr(__assign(__assign({ x: line2StartPoint.x, y: key === 'text' ? endY - 4 : endY + 16, text: key === 'text' ? text : subText }, constants_1.defaultLabelStyle), utils_1.getStyle(labelStyle, cfg, group, key)));
            });
        },
    }, 'single-edge');
};
exports.registerFundFlowItems = registerFundFlowItems;
