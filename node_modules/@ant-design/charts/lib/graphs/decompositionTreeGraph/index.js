...
var DecompositionTreeGraph = function (props) {
    ...
    react_1.useEffect(function () {
        ...
        if (!graph) {
            graph = new g6_1.default.TreeGraph({
                ...
                defaultEdge: {
                    type: edgeType,
                    edgeCfg: edgeCfg,
                    labelCfg: labelCfg === null || labelCfg === void 0 ? void 0 : labelCfg.style,
                },
        ...
        utils_1.renderGraph(graph, data);
        if (onReady) {
            onReady(graph);
        }
        return function () {
